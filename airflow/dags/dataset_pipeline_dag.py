...
AIRBYTE_MOVIE_CONNECTION_ID = Variable.get("AIRBYTE_MOVIE_CONNECTION_ID")
AIRBYTE_SEASON8_CONNECTION_ID = Variable.get("AIRBYTE_SEASON8_CONNECTION_ID")
AIRBYTE_JON_CONNECTION_ID = Variable.get("AIRBYTE_JON_CONNECTION_ID")
AIRBYTE_DAENERYS_CONNECTION_ID = Variable.get("AIRBYTE_DAENERYS_CONNECTION_ID")
