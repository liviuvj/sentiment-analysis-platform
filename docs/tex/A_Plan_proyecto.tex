...
\imagen{sprint3}{Gráfico \textit{burn-down} del \textit{Sprint} 3}
...
\imagen{sprint4}{Gráfico \textit{burn-down} del \textit{Sprint} 4}
...
\imagen{sprint5}{Gráfico \textit{burn-down} del \textit{Sprint} 5}
...
\imagen{sprint6}{Gráfico \textit{burn-down} del \textit{Sprint} 6}
...
\imagen{sprint7}{Gráfico \textit{burn-down} del \textit{Sprint} 7}
...
\imagen{sprint8}{Gráfico \textit{burn-down} del \textit{Sprint} 8}
...
\imagen{sprint9}{Gráfico \textit{burn-down} del \textit{Sprint} 9}
...
\imagen{sprint10}{Gráfico \textit{burn-down} del \textit{Sprint} 10}
...
\imagen{sprint11}{Gráfico \textit{burn-down} del \textit{Sprint} 11}
...
\tablaSmallSinColores{Coste total de un trabajador durante 5 meses}{l r}{total_cost}
{Concepto   &   Coste \\}
{
...
\tablaSmallSinColores{Versiones y licencias de las herramientas utilizadas}{l l l}{licenses}
