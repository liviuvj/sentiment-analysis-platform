...
\newcommand{\imagenConFuenteConAnchura}[4]{
	\begin{figure}[!h]
		\centering
		\includegraphics[width=#1\textwidth]{#2}
		\caption[#3]{#3. Fuente:~#4}\label{fig:#2}
	\end{figure}
	\FloatBarrier
}
...
\definecolor{positive}{HTML}{ACE1C4}
\definecolor{neutral}{HTML}{FDE380}
\definecolor{negative}{HTML}{EFA1AA}
\definecolor{optimism}{HTML}{FFD700}
\definecolor{joy}{HTML}{90EE90}
\definecolor{sadness}{HTML}{9370DB}
\definecolor{anger}{HTML}{FF2400}
...
% 
% Nuevo comando para los Casos de Uso
% Parámetros:
%   #1  ==> ID del Caso de Uso      (Ej: CU-01)
%   #2  ==> Nombre del Caso de Uso  (Ej: Caso de Uso 1)
%   #3  ==> Requisitos asociados    (Ej: RF1, RF2, ...)
%   #4  ==> Descripción             (Ej: Texto largo...)
%   #5  ==> Precondición            (Ej: Texto largo...)
%   #6  ==> Acciones                (Ej: \item Acción 1...
%                                        \item Acción 2...)
%   #7  ==> Postcondición           (Ej: Texto largo...)
%   #8 ==> Excepciones             (Ej: \item Excepción 1...
%                                        \item Excepción 2...)
%   #9 ==> Importancia             (Ej: Baja, Alta, ...)
...
\begin{center}%
	...
	\includegraphics[height=3cm]{img/escudoULE} \vspace{0.5cm}%
\end{center}%
...
\noindent Que el alumno D. \nombre, con DNI dni, ha realizado el Trabajo final de Máster en Inteligencia de Negocio y Big Data en Entornos Seguros titulado ``Herramienta \textit{open-source} para análisis de sentimientos en redes sociales''. 
...
\begin{abstract}
Deep learning, procesamiento de lenguaje natural, sentiment analysis, big data, ETL, \textit{dashboard}, visualización de datos, \textit{open-source}.
\end{abstract}
